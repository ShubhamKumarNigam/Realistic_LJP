...
for i in range(83,len(ll)):
  ...
  for j in range(0,len(llll)):
    ...
    counter=counter+1
    if counter % 250 == 0:
      response=lcpp_llm(prompt="You are asked to be a judge of a legal case and provide a judgment of the following legal judgment:-{"+temp+"}. Think Step by Step.", max_tokens=50, temperature=0.7, top_p=0.95,
